...
nice -n 6 ~/Transcriptome_Tools/TransDecoder-TransDecoder-v5.0.2/TransDecoder.Predict -t /media/RAID/james/Staghorn_GeneExpression/Ref_Transcriptome_All/Trinity-GG.final.fasta
...
# the annotation output from trinotate is sparse and unhelpful, use the script ParseAnnotations.py instead once you have the blast outputs

...
/media/RAID/james/Staghorn_GeneExpression/Ref_Transcriptome_All/Annotation/Trinity-GG.final.fasta  --est_method RSEM --aln_method bowtie2 --prep_reference --trinity_mode 
